...
const ContactPageCTA = () => {
  ...
  return (
    <div className="w-full max-w-[1440px] m-auto flex justify-center items-center px-6 tablet:px-14 laptop:px-[70px] py-20">
      <div
          ...
          <div className="flex flex-col justify-center items-center laptop:items-start gap-6 ">
            ...
            <div>
              <p className="text-white text-center laptop:text-left">
                Discover how Blink CX is redefining customer experience, one
                transformative program at a time.
              </p>
            </div>
          </div>
          <div>
          ...
          <div className="flex flex-col gap-5 w-full laptop:w-10/12">
            <div className="px-4 py-6 bg-white rounded-lg flex items-center gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="text-sm tablet:text-base font-semibold text-[#333333]">
                  Email address
                </div>
                <div>
                  <a
            ...
            <div className="px-4 py-6 bg-white rounded-lg flex items-center gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="text-sm tablet:text-base font-normal text-[#333333]">
                  Weekdays 9am to 6pm GMT+8
                </div>
              </div>
            </div>
            <div className="px-4 py-6 bg-white rounded-lg flex items-center gap-4">
