        ...
        <div className="heading flex flex-col gap-6">
          <div className="flec flex-col gap-2">
            ...
            <div className="title  flex">
              <h1 className="leading-[30px]font-normal tablet:font-semibold tablet:leading-[72px] text-[#333333]">Achieving Customer Excellence Together,
              ...
              >Captured in a blink</span>
              </h1>
              
            </div>
          </div>

          <p className="max-w-[594px]">Blink CX's approach to customer excellence is a journey we embark on together, one Blink at a time.</p>
        </div>
