...
const EventCard = () => {
  return (
    <div className="max-w-[421px] flex justify-center items-center px-3 pt-3 pb-6 rounded " style={{boxShadow: "0px 2px 20px 0px rgba(0, 0, 0, 0.10)"}}>
      <div className="flex flex-col gap-5 justify-center items-center">
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-4">
            ...
            <div className="text-[#333333]">June 1, 2023 • Thursday, 9:00 AM</div>
          ...
          <div>
            <button className="py-3 px-6 rounded-lg border-[1px] text-[#6C52E3] border-[#6C52E3]">Register here</button>
          </div>
        </div>
      </div>
    </div>
