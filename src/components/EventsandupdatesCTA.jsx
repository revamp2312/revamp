...
const EventsandupdatesCTA = () => {
  ...
  return (
    <div className="w-full max-w-[1440px] m-auto flex justify-center items-center px-6 laptop:px-[70px] py-20">
      <div
        className="flex flex-col gap-12 laptop:flex-row laptop:gap-0 justify-center px-6 laptop:px-[70px] py-12 w-full "
        style={style}
      >
          ...
          <div className="flex flex-col gap-5 w-full laptop:w-10/12">
            <div className="px-6 py-6 bg-white rounded-lg flex items-center justify-between">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div>
                    <a
                      ...
                      href="https://www.facebook.com/blinkdigitalPH"
                    >
                      Blink Digital
                    </a>
                  </div>
              ...
              <div className="w-[10px]">
                <a target="blank" href="https://www.facebook.com/blinkdigitalPH">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div>
                    <a
                      className="text-base font-normal text-[#693ED4]"
                      href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQGQWqDNO5amHQAAAYwPvYmoFoRMuGShgIB4SC0hOWrPoqYXizlGYGKhqL-H9q5dIIALKcIeW02jOanmF3ijDyyDpfnrURBvivB9JIKdgnypJm5daFqR5k5EZQucbK4O9TxfyXE=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2Fblink-digital-ph%2Fmycompany%2F"
                    >
                      Blink Digital
                    </a>
                  </div>
            ...
            <div className="px-6 py-6 bg-white rounded-lg flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div>
                    <a target="blank"
                      className="text-base font-normal text-[#693ED4]"
                      href="https://www.youtube.com/@blinkcustomerexperience7943"
                    >
              ...
              <div className="w-[10px]">
              <a target="blank" href="https://www.youtube.com/@blinkcustomerexperience7943">
                <img className="w-full" alt="arrrow" src={eventarrow} />
              </a>
              </div>
            </div>
            <div className="px-6 py-6 bg-white rounded-lg flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div>
                    <a
                      className="text-base font-normal text-[#693ED4]"
                      href="https://twitter.com/i/flow/login?redirect_after_login=%2FBlinkCX"
                    >
                      Blink Digital
                    </a>
                  </div>
              ...
              <div className="w-[10px]">
              <a target="blank" href="https://twitter.com/i/flow/login?redirect_after_login=%2FBlinkCX">
               <img className="w-full" alt="arrrow" src={eventarrow} />
              </a>
              </div>
            </div>
