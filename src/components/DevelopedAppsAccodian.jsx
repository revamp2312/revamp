...
import { daAcc, daAccSecond } from "../constants/utils";
import Accordion from "./Accordion";
import AccordionSecond from "./AccordionSecond";
import AccordionImage from "./AccordionImage";
import { motion, useAnimation } from "framer-motion";
import { developedAppsAccordianImages } from "../constants/accordianimages";
        ...
        <div className="flex flex-col gap-12 justify-center items-center rounded-3xl bg-[#F7F5FF] p-12">
          ...
          <div className="flex">
            <div className="w-6/12">
              ...
              >
                {developedAppsAccordianImages.map((each, index) => {
                  return (
                    <AccordionImage
                      key={index}
            ...
            <div className="w-6/12">
              <div className="flex justify-center items-center">
                <div className="flex flex-col gap-4">
                  {daaccordioandata.map((each, index) => {
                    return (
                      <Accordion
                        key={index}
        ...
        <div className="flex flex-col gap-12 justify-center items-center  ">
          <div className="flex">
            ...
            <div className="w-6/12 flex justify-end ">
              <div>
                <img className="w-full" src={daAccSecond} />
              </div>
            </div>
          </div>
        </div>
