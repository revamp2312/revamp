      ...
      <div className="flex flex-col gap-12 ">
        {partnerdata.map((partner, index) => {
          ...
          return (
            <div
              key={index}
              className="each-partners flex justify-center items-center laptop:flex-row   gap-5 "
              style={
                rowReverse
            ...
            >
              <div className="w-full flex justify-center items-start laptop:w-5/12 max-w-[530px] ">
                <img className="w-full" src={logo} />
              </div>
              <div className="w-full laptop:w-7/12 flex flex-col gap-12 py-6 px-6 tablet:px-12 rounded-lg bg-[#F7F5FF] justify-center">
