    ...
    <div className="w-full max-w-[1440px] m-auto flex flex-col justify-center items-center p-[70px]">
      ...
      <div className="w-full relative flex flex-col justify-center items-center">
        ...
        <div className="singapore-address rounded-md  flex flex-col absolute left-[225px] bottom-[110px]  max-w-[339px] py-6 px-4 justify-center items-start">
          <div className="text-xl font-semibold bg-[#F7F5FF] p-4 pb-0">
            Singapore
          </div>
          <div className="text-base font-normal bg-[#F7F5FF] p-4 ">
        ...
        <div className="filipino-address rounded-md flex flex-col absolute top-[30px] right-[20px] max-w-[339px] py-6 px-4 justify-center items-start">
          <div className="text-xl font-semibold p-4 bg-[#F7F5FF] pb-0">
            Philippines
          </div>
          <div className="text-base font-normal p-4 bg-[#F7F5FF]">
