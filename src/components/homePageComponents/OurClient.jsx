      ...
      <div className="ourclient-wrapper max-w-[1048px] flex flex-col justify-center items-center gap-14">
        ...
        className="bottom flex flex-col-reverse laptop:flex-row rounded-xl p-2 tablet:p-4 bg-[#f7f5ff]">
          <div className="left w-full laptop:w-[75%]  ">
            ...
            <div className="h-[1px] bg-[#D3D0D0] w-full"></div>
          ...
          <div className="right flex w-full laptop:w-1/4 justify-start laptop:justify-center items-center opacity-100 bg-[#fff] pt-2 laptop:pt-0">
            <div className="w-[220px] client-company-img scale-100 transition-all duration-200 hover:scale-110">
                <img className="w-full" src={pldt}/>
            </div>
          </div>
        </div>
      </div>
